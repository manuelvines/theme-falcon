...
var renderCalendar = function renderCalendar(el, option) {
  ...
  var options = merge({
    ...
    views: {
      dayGridMonth: {
          ...
          titleFormat: function(date) {
            return date.start.day.toString().padStart(2, '0') + "-" + date.end.day.toString().padStart(2, '0') + " " + MONTH_NAMES[date.end.month]  + " "  + date.end.year
         },
      },
      timeGridWeek: {
        dayHeaderContent: function(arg) {
      ...
      timeGridDay: {
        dayHeaderContent: function(arg) {
      	...
      	titleFormat: function(date) {
      		return date.start.day.toString().padStart(2, '0')  + " - " + MONTH_NAMES[date.end.month] 
      	},
      },
      listYear: {
          dayHeaderContent: function(arg) {
        	// alert('fecha...'+arg.date);
        	 var options = { weekday: 'long', year: 'numeric', month: 'long', day: 'numeric' };
        	 var today  = arg.date;
        	 //console.log(today.toLocaleDateString("es-MX", options)); // Saturday, September 17, 2016
        	 // alert('fecha==>'+today.toLocaleDateString("es-MX", options));
        	 var fecha = today.toLocaleDateString("es", options);
        	 //var fechaArr = fecha.split('de');
        	 // alert('fechaArr[0]==>'+fechaArr[1]);
        	// return capitalizarPrimeraLetra(fechaArr[0]) + ', ' + fechaArr[2] + ' de ' + capitalizarPrimeraLetra(fechaArr[1]) + ' del '+ fechaArr[3];
        	 return reemplazarCadena(fecha);
            // return DAY_NAMES[arg.date.getDay()] + " " + arg.date.getDay().toString().padStart(2, '0') + ' de ' + MONTH_NAMES[arg.date.getMonth().toString()] + ' del ' + arg.date.getYear().toString();
        	  // return date.start.day.toString().padStart(2, '0')  + " - " + MONTH_NAMES[date.end.month]
        },
        	titleFormat: function(date) {
        		// alert('Fecha==>'+date.end.year);
        		// return date.start.day.toString().padStart(2, '0')  + " - " + MONTH_NAMES[date.end.month]
    ...
    // dayHeaderContent: function(arg) {
    //   // return DAY_NAMES[arg.date.getDay()] + ' ' + (arg.date.getDate() + 1 )+ " De " + MONTH_NAMES[arg.date.getMonth()] + " De " + arg.date.getFullYear()
...
function reemplazarCadena(strCadena) {
	if (strCadena.indexOf('coles') > -1){
		var pos = strCadena.indexOf('coles');
		strCadena = strCadena.substr(0, pos - 4) + strCadena.substr(pos);
	}
	if (strCadena.indexOf('bado') > -1){
		var pos = strCadena.indexOf('bado');
		strCadena = strCadena.substr(0, pos - 2) + strCadena.substr(pos);
	}
	var newString =   strCadena.replaceAll('enero', 'Enero')
							   .replaceAll('febrero', 'Febrero')
							   .replaceAll('marzo', 'Marzo')
							   .replaceAll('abril', 'Abril')
							   .replaceAll('mayo', 'Mayo')
							   .replaceAll('junio', 'Junio')
							   .replaceAll('julio', 'Julio')
							   .replaceAll('agosto', 'Agosto')
							   .replaceAll('septiembre', 'Septiembre')
							   .replaceAll('octubre', 'Octubre')
							   .replaceAll('noviembre', 'Noviembre')
							   .replaceAll('diciembre', 'Diciembre')
							   .replaceAll('lunes', 'Lunes')
							   .replaceAll('martes', 'Martes')
							   .replaceAll('coles', 'Miércoles')
							   .replaceAll('jueves', 'Jueves')
							   .replaceAll('viernes', 'Viernes')
							   .replaceAll('bado', 'Sábado')
...
{
  title: "CONFIGURACION DE EMPRESAS TOYOTA",
  start: "2024-02-27 -01 10:00:00",
  end: "2024-02-29 -03 16:00:00",
  description: "CONFIGURACION DE EMPRESAS TOYOTA",
  className: "bg-danger-subtle",
  id: 13   
  },
  {
    title: "SOPORTE AL SISTEMA MYVISITOR",
    start: "2024-02-28 -01 10:00:00",
    end: "2024-02-28 -03 16:00:00",
    description: "SOPORTE AL SISTEMA MYVISITOR",
    className: "bg-danger-subtle",
    id: 14
  },
  {
  ...
  {
    title: "SOPORTE AL SISTEMA MYVISITOR",
    start: "2024-03-04 10:00:00",
    end: "2024-03-04 11:00:00",
    description: "SOPORTE AL SISTEMA MYVISITOR",
    className: "bg-danger-subtle", 
    id: 16
  },
  {
    title: "SOPORTE AL SISTEMA MYVISITOR",
    start: "2024-03-06 11:00:00",
    end: "2024-03-06 12:00:00",
    description: "SOPORTE AL SISTEMA MYVISITOR",
    className: "bg-danger-subtle", 
    id: 17  
  },
  {
    title: "SOPORTE AL SISTEMA MYVISITOR",
    start: "2024-03-08 12:00:00",
    end: "2024-03-08 13:00:00",
    description: "SOPORTE AL SISTEMA MYVISITOR",
    className: "bg-danger-subtle", 
    id: 18  
  },
  {
    title: "SOPORTE AL SISTEMA MYVISITOR",
    start: "2024-03-11 13:00:00",
    end: "2024-03-11 14:00:00",
    description: "SOPORTE AL SISTEMA MYVISITOR",
    className: "bg-danger-subtle",  
    id: 19  
  },
  {
    title: "CONFIGURAR IMPRESORA HP 1",
    start: "2024-02-27T14:00:00",
    end: "2024-02-27T15:00:00",
    description: "CONFIGURAR IMPRESORA HP 1",
    className: "bg-danger-subtle",
    id: 20,
    
  },
  {
      title: "CONFIGURAR IMPRESORA HP 2",
      start: "2024-02-28 16:00:00",
      end: "2024-02-28 17:00:00",
      description: "CONFIGURAR IMPRESORA HP 2",
      className: "bg-danger-subtle",
      id: 21,
   
  },
  {
      title: "CONFIGURAR IMPRESORA HP 3",
      start: "2024-02-29 18:00:00",
      end: "2024-02-29 19:00:00",
      description: "CONFIGURAR IMPRESORA HP 3",
      className: "bg-danger-subtle",
      id: 22
  ...
  {
    title: "TEST VISITA",
    start: "2024-03-12 19:00:00",
    end: "2024-03-12 20:00:00",
    description: "TEST VISITA",
    className: "bg-danger-subtle",  
    id: 23  
  },
  {
    title: "TEST PRUEBA DE AGENDA",
    start: "2024-03-05 20:00:00",
    end: "2024-03-05 21:00:00",
    description: "TEST PRUEBA DE AGENDA",
    className: "bg-danger-subtle",
    id: 24
  },
  {
    title: "TEST PRUEBA DE AGENDA",
    start: "2024-03-06 21:00:00",
    end: "2024-03-06 22:00:00",
    description: "TEST PRUEBA DE AGENDA",
    className: "bg-danger-subtle",
    id: 25
  },
